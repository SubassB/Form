;(function ($) {
    ...
    $('#mobilesearch').autocomplete({
        source: function (request, response) {
            $.ajax({
                url: $('#mobile-search-header').data('url'),
                type: 'GET',
                dataType: 'json',
                data: {
                    search: request.term
        ...
        select: function (event, ui) {
            ...
            window.location.href = '/product/single/' + ui.item.productValue
            return false
        }
    })
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    Object.keys(obj).forEach(function (key) {
                        bodyData =
                            '<div class="product-item cart-product-item"><div class="single-grid-product"><div class="product-top"><a href="single-product.html"><img class="product-thumbnal" src="' +
                            Img +
                            '/' +
                            obj[key]['options']['image'] +
                            '" alt="cart"></a></div><div class="product-info"><div class="product-name-part"><h3 class="product-name"><a class="product-link" href="single-product.html">' +
                            obj[key]['name'] +
                            ...
                            obj[key]['rowId'] +
                            '">Remove</button></div><div class="product-price"><span class="regular-price">' +
                            currsym +
                            currencyPrice(
