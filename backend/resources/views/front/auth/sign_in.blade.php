                    ...
                    <div class="login-wrap">
                        ...
                        <form class="login-form" method="post" action="{{route('user.sign.in.post')}}">
                            ...
                            <div class="form-group">
                                <input type="email" class="form-control rounded-left" placeholder="{{__('Email')}}" name="email" value="" required="">
                            </div>
                            <div class="form-group d-flex">
                                <input type="password" class="form-control rounded-left" placeholder="{{__('Password')}}" name="password" value="" required="">
                            </div>
                            <div class="form-group">
