                        ...
                        <a class="single-categorie" href="{{route('category.product',$item->id)}}">
                            <div class="categorie-wrap">
                                <div class="categorie-icon">
                                    ...
                                    <img src="{{$item->Category_Image ? asset(CategoryImage() . $item->Category_Image):  asset('frontend/assets/images/no-image.png')}}">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-md-12">
                                    <div class="offer_modal_left">
                                        ...
                                        <p class="m-0">{{__('Subscribe to the Omijeenamailing list to receive updates on new arrivals, special offers and our promotions.')}}</p>
