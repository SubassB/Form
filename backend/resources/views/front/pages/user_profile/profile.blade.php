                    ...
                    <div class="user-profile-right-part">
                        <div class="user-profile-content-box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="address-box card">
                                        <h3 class="text-black">{{__('Address & Contact Us')}}</h3>
                                        <ul>
                                            <li>{{$user->email}}</li>
                                ...
                                <div class="col-md-4">
                                    <div class="address-box card">
                                        <h3 class="text-black">{{__('Billing Address')}}</h3>
                                        <ul>
                                            <li>{{__('Name:')}} {{$billing->Name}}</li>
                                            <li>
                                                {{__('Street:')}}
                                                {{is_null($billing->Street) ? __('Not to update yet') : $billing->Street}}</li>
                                                <li>
                                                    {{__('Phone:')}}
                                                    {{is_null($billing->Phone_no) ? __('Not to update yet') : $billing->Phone_no}}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
