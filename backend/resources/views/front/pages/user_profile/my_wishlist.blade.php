        ...
        <div class="container">
            <div class="breadcrumb-wrap text-center">
                ...
                <ul class="breadcrumb-pages">
                    ...
                    <li class="page-item">{{__('My Wish List')}}</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="user-profile-right-part">
                        <div class="user-profile-content-box my-reviwe-list-box">
                            ...
                            <div class="d-flex justify-content-between align-items-center text-black mb-5">
                                <h2 class="user-profile-content-title">{{__('My Wish List')}}</h2>
                            </div>
                            <div class="row">
                              ...
                              <div class="col-md-4">
                                <div class="single-review-item bg-white d-flex align-items-center">
                                    <div class="review-left flex-shrink-0">
                                        <a href="{{route('single.product',$wish->products->id)}}"><img class="product-thumbnail" src="{{asset(ProductImage().$wish->products->Primary_Image)}}" alt="product"></a>
                                    </div>
                                    <div class="review-right flex-grow-1">
                                        <h4 class="product-name"><a href="{{route('single.product',$wish->products->en_Product_Slug)}}">{{$wish->products->en_Product_Name}}</a></h4>
                                        {!!  productReview($wish->products->id) !!}
                            ...
                            @empty
                                <div class="single-review-item bg-white d-flex align-items-center">
                                    <div class="review-right flex-grow-1">
                                        <h4 class="product-name">{{__('Wishlist is empty!')}}</h4>
                                    </div>
                                </div>
                              </div>
                            @endforelse
