...
@section('content')
    <!-- breadcrumb area start here  -->
        ...
        <div class="container">
            <nav class="breadcump-top" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="{{route('front')}}">{{__('Home')}}</a></li>
                  <li class="breadcrumb-item">
                    <a href="{{route('category.product',$products->category->id)}}">
                        {{ $products->category->en_Category_Name }}
                    </a>
                  </li>
                  <li class="breadcrumb-item active" aria-current="page">{{ $products->en_Product_Name }}</li>
                </ol>
              </nav>
    </div>
            ...
            <div class="product-single-details">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <div class="zoom-left">
                            <img style="border:1px solid #e8e8e6; width:350px; height:320px" id="zoom_03" src="{{asset(ProductImage().$products->Primary_Image)}}" 
                            data-zoom-image="{{asset(ProductImage().$products->Primary_Image)}}"
                             />
                                            
                            <div id="gallery_01" style="float:left; margin-top:10px">
                             
                            <a  href="#" class="elevatezoom-gallery active" data-update="" data-image="{{asset(ProductImage().$products->Primary_Image)}}" 
                            data-zoom-image="{{asset(ProductImage().$products->Primary_Image)}}">
                            <img src="{{asset(ProductImage().$products->Primary_Image)}}" width="100"  /></a>
                            
                            <a  href="#" class="elevatezoom-gallery"
                                 data-image="{{asset(ProductImage().$products->Image4)}}"
                                 data-zoom-image="{{asset(ProductImage().$products->Image4)}}"
                                ><img src="{{asset(ProductImage().$products->Image4)}}" width="100"  /></a>
                            
                            <a href="tester" class="elevatezoom-gallery" 
                                 data-image="{{asset(ProductImage().$products->Image3)}}"
                                 data-zoom-image="{{asset(ProductImage().$products->Image3)}}">
                                 <img src="{{asset(ProductImage().$products->Image3)}}" width="100"  />
                            </a>
                            
                            <a href="tester" class="elevatezoom-gallery" 
                                 data-image="{{asset(ProductImage().$products->Image5)}}"
                                 data-zoom-image="{{asset(ProductImage().$products->Image5)}}"
                                 
                                 class="slide-content"
                                ><img src="{{asset(ProductImage().$products->Image5)}}" width="100"  /></a>
                                ...
                                <a href="tester" class="elevatezoom-gallery" 
                                 ...
                                 class="slide-content"
                                ><img src="{{asset(ProductImage().$products->Image2)}}" width="100"  /></a>
                        ...
                        {{-- <div class="product-single-left">
                            <div class="product-thumbnail-image">
                                <ul class="product-thumb-silide slider slider-nav">
                                    ...
                                    <li class="single-item"><img class="single-item-image" src="{{asset(ProductImage().$products->Image4)}}" alt="{{__('product')}}" /></li>
                                    <li class="single-item"><img class="single-item-image" src="{{asset(ProductImage().$products->Image3)}}" alt="{{__('product')}}" /></li>
                                    <li class="single-item"><img class="single-item-image" src="{{asset(ProductImage().$products->Image5)}}" alt="{{__('product')}}" /></li>
                                    <li class="single-item"><img class="single-item-image" src="{{asset(ProductImage().$products->Image2)}}" alt="{{__('product')}}" /></li>
                                </ul>
                            </div>
                            <div class="product-slier-big-image">
                                <div class="product-priview-slide slider slider-for">
                                    <div class="single-slide">
                                        <img class="slide-image zoom_1" src="{{asset(ProductImage().$products->Primary_Image)}}" alt="{{__('product')}}" />
                                    </div>
                                    <div class="single-slide">
                                        <img class="slide-image zoom_1" src="{{asset(ProductImage().$products->Image4)}}" alt="{{__('product')}}" />
                                    </div>
                                    <div class="single-slide">
                                        <img class="slide-image zoom_1" src="{{asset(ProductImage().$products->Image3)}}" alt="{{__('product')}}" />
                                    </div>
                                    <div class="single-slide">
                                        <img class="slide-image zoom_1" src="{{asset(ProductImage().$products->Image5)}}" alt="{{__('product')}}" />
                                    </div>
                                    <div class="single-slide">
                                        <img class="slide-image zoom_1" src="{{asset(ProductImage().$products->Image2)}}" alt="{{__('product')}}"  data-zoom-image="{{asset(ProductImage().$products->Image2)}}" alt="{{__('product')}}"/>
                                    </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="product-info">
                                        ...
                                        <h3 class="product-name">{{langConverter($products->en_Product_Name,$products->fr_Product_Name)}}</h3>
                                            ...
                                            <div class="prdouct-btn-wrapper d-flex align-items-right">
                                                {!!  productReview($products->id) !!}
                                               
                                                <ul class="single-product-header-btn">
                                                    <li>
                                                        <a class="addCompare product-btn MyWishList float-end" data-id="{{$products->id}}" title="{{__('Add To Wishlist')}}"><i class="icon flaticon-like"></i></a>
                                                    </li>
                                                    <li>
                                                  ...
                                                  <ul class="product-tag-list">
                                                    ...
                                                    <li class="pnameroduct-catagory">{{$ppt->tag}}</li>
                                                @endforeach
                                                  </ul>
                                            </div>
                                            <p style="margin-top:-20px">
                                                Brand: <a class="brand-link" href="{{route('brand.product',$products->brand->id)}}" >{{ $products->brand->en_BrandName }}</a>
                                            </p>
                                            <hr/>
                                        ...
                                        <div class="product-bottom-button d-flex">
                                            ...
                                            <a href="javascript:void(0)" title="{{__('Add To Cart')}}" class="add-cart addCart" data-id="{{$products->id}}">{{__('Add To Cart')}} <i class="icon fas fa-plus-circle"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product-right-bottom">
                                        ...
                                        <div class="share-area mt-30">
                                            ...
                                            <ul class="social-media a2a_kit text-center">
