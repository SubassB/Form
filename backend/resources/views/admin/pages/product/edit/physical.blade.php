                                  ...
                                  <div class="row">
                                      <div class='col-md-4'>
                                          <div class="input__group mb-25">
                                              ...
                                              <input type="text" 
                                              value="{{$product->en_Product_Name}}"
                                              class="form-control" id="en-product-name" name="en_product_name">
                                      ...
                                      <div class="col-md-4">
                                          <div class="input__group mb-25">
                                              ...
                                              <input type="text" 
                                              value="{{$product->en_Product_Slug}}"
                                              class="form-control" id="en-product-slug" name="en_product_slug">
                                              <span class="help-block error">
                          ...
                          <div class="row">
                              <div class="col-md-6">
                                  <div class="input__group mb-25">
                                      ...
                                      <textarea name="en_about" id="en_about" class="form-control" rows="21">{!! $product->en_About !!}</textarea>
                                      <span class="help-block error">
