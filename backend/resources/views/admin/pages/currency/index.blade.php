                ...
                <form enctype="multipart/form-data" method="POST" action="{{route('admin.store_currency')}}">
                    <div class="modal-body">
                        ...
                        <div class="input__group mb-25">
                            ...
                            <input type="text" name="currency" placeholder="{{__('Currency')}}" required>
                        </div>
                        <div class="input__group mb-25">
                            <label for="exampleInputEmail1">{{ __('ISO')}}</label>
                            <input type="text" name="iso" placeholder="{{__('ISO')}}" required>
                        </div>
                        <div class="input__group mb-25">
                            <label for="exampleInputEmail1">{{ __('Symbol')}}</label>
                            <input type="text" name="symbol" placeholder="{{__('Symbol')}}" required>
                        </div>
                        <div class="input__group mb-25">
                            <label for="exampleInputEmail1">{{ __('Conversion Rate')}}</label>
                            <input type="number" name="convert_from_usd" min="1" step="0.01" placeholder="{{__('Conversion Rate')}}" required>
                        </div>
                    </div>
