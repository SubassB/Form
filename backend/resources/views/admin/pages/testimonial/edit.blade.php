                                    ...
                                    <div class="col-md-12">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <textarea name="en_description" id="en_description" class="form-control">{{$edit->en_Description}}</textarea>
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <select name="star" id="star" class="form-control">
                                                    ...
                                                    <option value="1" {{$edit->star == 1 ? 'selected' : ''}}>{{__('1 Star')}}</option>
                                                    <option value="2" {{$edit->star == 2 ? 'selected' : ''}}>{{__('2 Star')}}</option>
                                                    <option value="3" {{$edit->star == 3 ? 'selected' : ''}}>{{__('3 Star')}}</option>
                                                    <option value="4" {{$edit->star == 4 ? 'selected' : ''}}>{{__('4 Star')}}</option>
                                                    <option value="5" {{$edit->star == 5 ? 'selected' : ''}}>{{__('5 Star')}}</option>
                                                </select>
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Image')}}</label>
                                                <input type="file" class="form-control putImage1"  name="image" id="image">
                                                <img  class="admin_image" src="{{asset(TestimonialImage().$edit->Image)}}" id="target1"/>
                                                {{$errors->first('image')}}
                                            </div>
