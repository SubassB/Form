                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-vertical__item bg-style">
                                        <form enctype="multipart/form-data" method="POST" action="{{route('admin.product.color.update')}}">
                                            @csrf
                                            <input type="hidden" name="id" value="{{$edit->id}}">
                                            <div class="input__group mb-25">
                                                <label for="exampleInputEmail1">{{ __('Color Name')}}</label>
                                                <input type="text" id="color_name" name="color_name" value="{{$edit->Name}}">
                                            ...
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" id="color_code" name="color_code" value="{{$edit->ColorCode}}">
                                                <span class="help-block error">
