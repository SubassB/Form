...
<head>
    ...
    <title>{{$allsettings['app_title']}}</title>
      ...
      <link rel="apple-touch-icon" href="{{asset(IMG_FAVICON_PATH.$allsettings['footer_logo'])}}">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-8 col-md-12">
                <div class="authentication__item">
                    <div class="authentication__item__logo text-center">
                        <a href="{{route('front')}}">
                            <img src="{{asset(IMG_LOGO_PATH.$allsettings['main_logo'])}}" alt="icon">
                        </a>
                    </div>
                    <div class="authentication__item__title mb-30 text-center">
                        <h2>{{__('Sign In')}}</h2>
                    </div>
