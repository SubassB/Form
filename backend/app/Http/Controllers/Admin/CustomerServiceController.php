...
class CustomerServiceController extends Controller
{
    ...
    public function customerServiceUpdate(Request $request)
    {
        ...
        if ($blog) {
            return redirect()->route('admin.customer.services')->with('toast_success', __('Successfully Updated !'));
        }
    ...
    public function faqStore(FaqStoreRequest $request)
    {
        ...
        if (!empty($create)) {
            return redirect()->back()->with('toast_success', __('Successfully Added!'));
        }
    ...
    public function faqUpdate(Request $request, $id)
    {
        ...
        return redirect()->back()->with('toast_error', __('Data not found!'));
    }
