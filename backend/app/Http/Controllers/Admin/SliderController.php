...
//       return $request->all();
           ...
           if ($slider) {
               return redirect()->route('admin.slider')->with('toast_success', __('Successfully Stored !'));
           }
        ...
        public function sliderUpdate(Request $request){
                ...
                if (!empty($update)) {
                    return redirect()->route('admin.slider')->with('toast_success', __('Successfully Update !'));
                }
       ...
       public function sliderDelete($id){
               ...
               if ($delete) {
                   $delete->delete();
                   return redirect()->route('admin.slider')->with('toast_success', __('Successfully Deleted !'));
               }
               return redirect()->route('admin.about.us')->with('toast_error', __('Does Not Delete!'));
       }
}
