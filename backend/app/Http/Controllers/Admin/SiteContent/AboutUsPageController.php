...
class AboutUsPageController extends Controller
{
    ...
    public function aboutPageUpdate(Request $request){
        ...
        if ($general) {
            return redirect()->route('admin.about.page.site.content')->with('toast_success', __('Successfully Updated !'));
        }
        return redirect()->route('admin.about.page.site.content')->with('toast_success', __('Does not Updated !'));
    }
}
