...
class HomePageController extends Controller
{
    ...
    public function homePageUpdate(Request $request){
        $id = $request->id;
        $general = Homepage::where('id', $id)->update([
        ...
        if ($general) {
            ...
            return redirect()->route('admin.home.page.site.content')->with('toast_success', __('Successfully Updated !'));
        }
        return redirect()->route('admin.home.page.site.content')->with('toast_success', __('Does not Updated !'));
    }
}
