...
class TestimonilController extends Controller
{
    public function testimonial(Request $request){
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->rawColumns(['action', 'en_Description', 'Image'])
                ->make(true);
        }
    ...
    public function testimonialStore(TestimonialTableRequest $request){
        ...
        if ($blog) {
            return redirect()->route('admin.testimonial')->with('toast_success', __('Successfully Stored !'));
        }
    ...
    public function testimonialDelete($id){
        ...
        if ($delete) {
            $delete->delete();
            return redirect()->route('admin.testimonial')->with('toast_success', __('Successfully Deleted !'));
        }
        return redirect()->route('admin.testimonial')->with('toast_error', __('Does Not Delete!'));
    }
