...
class ProductController extends Controller
{
    ...
    public function productFilteringHeader(Request $request)
    {
        $products = Product::select("en_Product_Name as value","en_Product_Slug as productValue", "id")
        ->where('en_Product_Name', 'LIKE', '%'. $request->get('search'). '%')
        ->get();
