...
Route::group(['middleware' => ['is_user']], function () {
    ...
    Route::get('country/{name}', [HomeController::class, 'countrySwitch'])->name('country.switch');
    ...
    Route::group(['prefix' => 'user/'], function () {
        ...
        Route::post('change-password', [AuthController::class, 'userChangePassword'])->name('user.profile.change.password');
        //forget password
        Route::get('forget-password', [AuthController::class, 'userForgetPasswordGet'])->name('forget.password.get');
        Route::post('forget-password', [AuthController::class, 'userForgetPasswordPost'])->name('forget.password.post');
        Route::get('reset-password/{token}', [AuthController::class, 'userShowResetPasswordForm'])->name('reset.password.get');
        Route::post('reset-password', [AuthController::class, 'submitResetPasswordForm'])->name('reset.password.post');

        //User Profile
        Route::post('change-billing', [UserProfileController::class, 'userChangeBilling'])->name('user.profile.change.billing');
        ...
        Route::get('my-wishlist', [UserProfileController::class, 'myWishList'])->name('user.profile.myWishList');
    });
    ...
    Route::group(['prefix' => 'product'], function () {
        ...
        Route::get('filter/header', [ProductController::class, 'productFilteringHeader'])->name('product.filtering.header');
    });
    ...
    Route::group(['prefix' => 'wishlist'], function () {
        ...
        Route::get('add', [WishlistController::class, 'productWishlist'])->name('product.wishlist');
        Route::get('delete', [WishlistController::class, 'wishlistDelete'])->name('wishlist.delete');
    });
    Route::group(['prefix' => 'compare'], function () {
        Route::get('', [CompareListController::class, 'Compare'])->name('compare');
        Route::get('add', [CompareListController::class, 'compareList'])->name('compare.list');
        Route::get('delete', [CompareListController::class, 'compareListDelete'])->name('compare.delete');
    });
